  ...
  <div class="container">
    <div class="box">
      ...
      <form id="profileForm" method = "post">
        <div class="form-group"><label for="name">Full name</label><input id="name" name = "fullname" type="text" value = "${fullname}"></div>
        <div class="form-group"><label for="name">Email</label><input id="name" name = "email" type="text" value = "${email}"></div>
