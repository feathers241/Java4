...
<body>
  ...
  <script>document.getElementById('forgotForm').addEventListener('submit',function(e){e.preventDefault();alert('If this email exists, a reset link will be sent.');history.back();});</script>
</body>
</html>