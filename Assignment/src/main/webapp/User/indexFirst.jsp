...
<body>
	<c:url value = "${pagecontext.request.ContextPath}/Assignment" var = "url"/>
    <!-- Header -->
    <header>
            ...
            <div class="carousel-container">
                <div class="content-grid">
                	<c:forEach items = "${list}" var = "a">
                        ...
                        <a href="DetailFirst?id=${a.id}" class="video-card-link">
                            ...
                            <a href="Login" class="like-link">
                                <button class="video-btn like-btn">Like</button>
                            </a>
                            <a href="Login" class="share-link">
                ...
                <div class="pagination-controls">
                     <a href="${pageContext.request.contextPath}/indexFirst?page=1&userid=${userid}"><button class="pagination-btn" title="First">|&lt;</button></a>
                     <a href="${pageContext.request.contextPath}/indexFirst?page=${page > 1 ? page - 1 : 1}&userid=${userid}"><button class="pagination-btn" title="Previous">&lt;&lt;</button></a>
                     <a href="${pageContext.request.contextPath}/indexFirst?page=${page < 1 ? 1 : page+1}&userid=${userid}"><button class="pagination-btn" title="Next">&gt;&gt;</button></a>
                     <a href="${pageContext.request.contextPath}/indexFirst?page=${last}&userid=${userid}"><button class="pagination-btn" title="Last">&gt;|</button></a>
                </div>
