...
<body>
  <header><div class="header-container"><div class="logo">Online Entertainment</div>
  ...
  <div class="container">
    <div class="box">
      ...
      <form id="changeForm" method = "post">
        <div class="form-group"><label for="current">Mật khẩu hiện tại</label><input id="current" type="password" required name = "currentpassword" value = "${currentpassword}"></div>
        <div class="form-group"><label for="newpass">Mật khẩu mới</label><input id="newpass" type="password" required name = "newpassword"></div>
        <div class="form-group"><label for="confirm">Xác nhận mật khẩu mới</label><input id="confirm" type="password" required name = "confirmpassword"></div>
        <div class="actions"><button class="btn btn-primary" type="submit">Đổi mật khẩu</button></div>
      </form>
    </div>
  </div>
